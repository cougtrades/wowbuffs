...
// Add this near the top of your script.js with other initialization code
document.addEventListener('DOMContentLoaded', function() {
    // Load twitch clips
    fetch('./twitch_clips.html')
        .then(response => response.text())
        .then(html => {
            const content = document.getElementById('twitch-clips-content');
            content.innerHTML = html;
            
            // After loading content, wrap each clip in the necessary carousel structure
        ...
        .catch(error => {
            ...
            document.getElementById('twitch-clips-content').innerHTML = 
                '<p>Error loading clips. Please try again later.</p>';
        });
});

// Update your existing carousel initialization function
